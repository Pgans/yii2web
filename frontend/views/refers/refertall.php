...
$this->params['breadcrumbs'][] = 'รายงานผู้มารับบริการในโรงพยาบาลที่มีการส่งต่อ(สูงกว่า)';
?>
<b>รายงานผู้มารับบริการในโรงพยาบาลที่มีการส่งต่อ(สูงกว่า)</b>
<div class='well'>
...
echo GridView::widget([
        ...
        'panel' => [
            'before'=>'รายงานผู้มารับบริการในโรงพยาบาลที่มีการส่งต่อ(สูงกว่า)',
