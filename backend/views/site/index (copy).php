...
$this->title = 'My Yii M30hospital(045489064)';
?>
<div class="site-index">

    <div class="jumbotron">
        <h1>โรงพยาบาลม่วงสามสิบ</h1>

        <p class="lead">m30hospital ศูนย์คอมพิวเตอร์ โรงพยาบาลม่วงสามสิบ</p>

       <p><a class="btn btn-lg btn-primary" href="http://localhost/yii2a-devices/frontend/web/index.php?r=site%2Flogin">เข้าสู่ระบบการทำงาน</a></p>
    </div>
